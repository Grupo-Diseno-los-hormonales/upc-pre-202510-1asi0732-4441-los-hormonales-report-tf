...
1. ¿Qué impresión general te dejó la app HormonalCare después de ver todos los módulos (paciente, médico y administrador)?
2. ¿Te pareció clara la propuesta y objetivo principal de la aplicación?
3. ¿Cómo evaluarías la organización y navegación entre las diferentes secciones?
4. ¿Qué parte te pareció más intuitiva o fácil de entender y por qué?
5. ¿Hubo alguna sección que te resultó confusa o poco clara?
6. ¿Qué opinas del diseño visual de la app (colores, tipografía, iconografía)?
7. ¿Qué tan bien crees que se adapta esta app a las necesidades de pacientes con enfermedades hormonales?
8. Desde lo que viste del rol médico, ¿crees que las herramientas presentadas (historia clínica, calendario, notas) serían útiles para un endocrinólogo?
9. ¿La parte administrativa (gestión de usuarios, control de citas, etc.) te pareció funcional y bien organizada?
10. ¿Notaste alguna funcionalidad innecesaria o que podría mejorarse?
11. En general, ¿cómo calificarías la experiencia de usuario que ofrece la app (fluidez, claridad, facilidad)?
...
| User Story ID | Title                                                | Task ID | WorkItem/Task Title                                | Description                                                                                      | Estimation (Story Points) | Assigned To | Status   |
|---------------|------------------------------------------------------|---------|----------------------------------------------------|--------------------------------------------------------------------------------------------------|----------------------------|--------------|----------|
| UA01          | Activar modo oscuro manualmente                      | TK1     | Crear botón de modo oscuro                         | Agregar un botón en Configuración para activar/desactivar el modo oscuro.                        | 1                          | Jherson      | Done     |
|               |                                                      | TK2     | Implementar cambio de tema                         | Configurar el cambio de tema claro a oscuro en toda la app.                                     | 1                          | Abraham      | Done     |
| UA02          | Cambiar idioma de la app                             | TK3     | Crear selector de idioma                           | Agregar un menú de selección de idioma (español / inglés).                                      | 2                          | Brenda       | Done     |
|               |                                                      | TK4     | Traducir textos de la interfaz                     | Traducir manualmente los textos principales al inglés y viceversa.                              | 3                          | Diego        | Done     |
| UA03          | Ver saludo personalizado con nombre                  | TK5     | Obtener nombre del usuario                         | Recuperar el nombre del usuario al iniciar sesión.                                              | 1                          | Jherson      | Done     |
|               |                                                      | TK6     | Mostrar saludo dinámico en dashboard               | Mostrar “Hola, [nombre]” al entrar al dashboard.                                                | 1                          | Abraham      | Done     |
| UA04          | Mostrar fecha actual en la pantalla de citas         | TK7     | Agregar encabezado con fecha actual                | Mostrar la fecha actual al inicio de la pantalla de citas.                                      | 1                          | Brenda       | Done     |
|               |                                                      | TK8     | Ocultar encabezado fuera de la pantalla de citas   | Asegurar que el encabezado solo se muestre en la pantalla de citas.                            | 1                          | Diego        | Done     |
| UA05          | Ver ícono de verificado en médicos confirmados       | TK9     | Añadir ícono de médico verificado                  | Mostrar un ícono distintivo a médicos aprobados en la lista.                                   | 1                          | Brenda       | Done     |
|               |                                                      | TK10    | Validar estado de verificación del médico          | Consultar en backend si el médico está verificado.                                              | 1                          | Jherson      | Done     |
| UA06          | Confirmación antes de cerrar sesión                  | TK11    | Implementar botón de cerrar sesión                 | Añadir un botón visible en el menú de configuración.                                            | 1                          | Abraham      | Done     |
|               |                                                      | TK12    | Mostrar diálogo de confirmación                    | Mostrar alerta con opciones “Cancelar” y “Cerrar sesión”.                                       | 1                          | Diego        | Done     |
| UA07          | Agregar botón “Volver al inicio” en scroll largo    | TK13    | Detectar scroll largo en landing page              | Identificar cuando el usuario ha hecho scroll hasta el fondo.                                  | 1                          | Brenda       | Done     |
|               |                                                      | TK14    | Añadir botón flotante “↑ Inicio”                   | Crear un botón flotante que lleve al inicio de la página.                                       | 1                          | Jherson      | Done     |
| UA08          | Ver estado “en línea” del médico                     | TK15    | Mostrar estado del médico                          | Mostrar “En línea” o “Desconectado” en perfil del médico.                                       | 2                          | Diego        | Done     |
|               |                                                      | TK16    | Integrar verificación en tiempo real               | Consultar el estado en tiempo real mediante WebSocket o polling.                                | 1                          | Abraham      | Done     |
...
| Entrevistado            | Andre Lopez                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Apellidos               | Lopez                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Edad                    | 24                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Distrito de residencia  | Miraflores                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Enlace a la entrevista  | [Ver Video](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202214477_upc_edu_pe/Ec3dI6u6It9JmUTuNBLgMjwB4W74GhNkLYa0dtrUKeuX3Q?e=RYn80w&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)   |
| Hora de inicio          | 15:30                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Duración                | 09:51                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Imagen del entrevistado |   ![tobe17.png](images/tobe17.png)                                                                                                                                                                                                                                                                                                                                                                                |
| Resumen                 | Andre comentó que lo primero que le llamó la atención fue el diseño limpio de la pantalla y la claridad del encabezado. Opinó que el modo oscuro es fácil de identificar y lo usaría, que la fecha actual en la sección de citas ayuda mucho al médico a ubicarse, y que el saludo personalizado transmite cercanía y profesionalismo. El ícono de verificado junto al médico le inspira confianza, y ver el estado “en línea” le resultaría útil para saber cuándo comunicarse. Considera práctico el botón flotante para volver al inicio cuando hay mucho contenido. También indicó que el mensaje de confirmación al cerrar sesión es claro y ayuda a evitar errores. El cambio de idioma desde la configuración le pareció sencillo y accesible. Finalmente, mencionó que ningún botón o ícono le resultó confuso y que la experiencia general es intuitiva. |
---
#### Entrevista 2

| Campo                       | Detalle                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Entrevistador**           | Jherson David Astuyauri Calderon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Entrevistado**            | Arnhol Alfredo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Apellidos**               | Castrejón Calderón                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Edad**                    | 20                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Distrito de residencia**  | Lima                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Duración**                | 8:48                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Imagen del entrevistado** | ![Entrevista Validación](assets/images/entrevistavalidacion.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Resumen**                 | El entrevistado mostró una valoración muy positiva respecto al diseño de la app. Indicó que todos los elementos le parecieron útiles y bien ubicados. Resaltó como claras y convenientes las funciones del botón “Modo Oscuro”, el saludo personalizado y el cambio de idioma. Además, consideró que el ícono de verificación junto al médico inspira confianza, y que el botón flotante para regresar al inicio es funcional. Opinó que mostrar si el médico está en línea es una guía útil, y que la confirmación al cerrar sesión ayuda a evitar errores. No reportó confusión con ningún ícono o texto y sugirió solo mejoras menores en la navegación. |
| **Enlace de entrevista**    | [Ver entrevista en OneDrive](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202218451_upc_edu_pe/EXSHVu4dX31NudHhQSwPLD4BPNwM238PrUECgKNhq7xt0Q?e=KZAVt7&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybS_)                                                                                                                                                                                                                                                                                                                                                   |
